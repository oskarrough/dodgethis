...
test.each([0, 0.2, 1, 3, 6, 10])(
	'cursor distance %s controls touchdown within available reach',
	(distance) => {
...
test('out-of-reach cursor uses available charge, not unlimited power', () => {
...
test('solver reads live height and damping', () => {
